    ...
    <section className="relative py-20 px-4 bg-gradient-to-b from-primary/10 to-background">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-4">
          Find Trusted Hajj & Umrah Packages
        </h1>
        <p className="text-xl text-muted-foreground mb-8">
          Compare verified providers in your city
        </p>
        <WhatsAppButton 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-16">
          ...
          >
            ...
            <p className="font-semibold">1000+ Pilgrims Served</p>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05 }}
            className="flex flex-col items-center"
          >
            ...
            <p className="font-semibold">50+ Verified Providers</p>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05 }}
          ...
          >
            ...
            <p className="font-semibold">Premium Hotel Options</p>
          </motion.div>
        </div>
      </motion.div>
    </section>
